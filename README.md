...
### 🛠️ Odak Alanlarım ve Kullandığım Teknolojiler
- **Bilgi Güvenliği & Uyum:** TCMB 6493, ISO 27001, PCI-DSS
- **Geliştirme Yaklaşımı (AI-Assisted):** Next.js, React, Supabase, Tailwind CSS

### 🚀 Üzerinde Çalıştığım Bazı Projeler
- 🛡️ **[Regulatory Compliance SaaS](https://github.com/kurtulfatih/regulatory-compliance-saas):** Ödeme ve e-para kuruluşları için TCMB 6493 uyumluluk süreçlerini yöneten, veri izolasyonuna ve güvenliğe odaklanan Multi-tenant SaaS platformu.
